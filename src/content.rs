...
pub fn encounter_monsters_rng(
    id: EncounterId,
    mut rng: Option<&mut crate::rng::RngSet>,
) -> Vec<MonsterId> {
    match id {
        EncounterId::SmallSlimes => {
            if rng
                .as_mut()
                .map(|r| r.misc.random_boolean())
                .unwrap_or(true)
            {
...
fn encounter_monsters_fixed(id: EncounterId) -> &'static [MonsterId] {
    match id {
        ...
        EncounterId::ShelledParasiteAndFungi => {
            &[MonsterId::ShelledParasite, MonsterId::FungiBeast]
        }
        ...
        EncounterId::Reptomancer => &[MonsterId::Dagger, MonsterId::Reptomancer, MonsterId::Dagger],
