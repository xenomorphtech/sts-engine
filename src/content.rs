...
fn encounter_monsters_fixed(id: EncounterId) -> &'static [MonsterId] {
    match id {
        ...
        EncounterId::DonuAndDeca => &[MonsterId::Deca, MonsterId::Donu],
        ...
        EncounterId::ColosseumNobs => &[MonsterId::Taskmaster, MonsterId::GremlinNob],
        EncounterId::GremlinLeader => &[
            MonsterId::GremlinWarrior,
            MonsterId::GremlinWarrior,
            MonsterId::GremlinLeader,
        ...
        EncounterId::Nemesis => &[MonsterId::Nemesis],
        ...
        EncounterId::TimeEater => &[MonsterId::TimeEater],
